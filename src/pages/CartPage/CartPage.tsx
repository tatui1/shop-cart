...
export const CartPage = () => {
  ...
  return (
    <Container sx={{ mt: 4 }}>
      ...
      <Typography variant="h4" gutterBottom sx={{ color: 'rgb(25, 118, 210)' }}>Корзина №{id}</Typography>
      
      <Box sx={{ mb: 4, p: 2, borderLeft: '4px solid rgb(25, 118, 210)', backgroundColor: 'rgb(240, 247, 255)' }}>
      ...
      <Box>
        {cart.products.map((product) => (
          <Box key={product.id} sx={{ display: 'flex', alignItems: 'center', py: 2, borderBottom: '1px solid rgb(238, 238, 238)' }}>
            ...
            <Box sx={{ ml: 2 }}>
              <Typography variant="body1" sx={{ fontWeight: '500', color: 'rgb(25, 118, 210)' }}>{product.title}</Typography>
